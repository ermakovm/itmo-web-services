...
public class Client {
    ...
    public void startClient() {
        ...
        int userChoice = 0;
        while ((userChoice = Integer.parseInt(scanner.nextLine())) > 0) {
            switch (userChoice) {
                case 1:
    ...
    private void processCustomRequest() {
        ...
        int criteriaCount = Integer.parseInt(scanner.nextLine());
        Request request = new Request();
        List<RequestData> requestData = request.getRequestData();
        for (int i = 0; i < criteriaCount; i++) {
            printSelectCriteria();
            int currentCriteria = Integer.parseInt(scanner.nextLine());
            ...
            printOperator(key);
            int operNumber = Integer.parseInt(scanner.nextLine());
